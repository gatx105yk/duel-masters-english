...
(function () {
  var TERMS = {
    ...
    "search": "\u63a2\u7d22 tansaku \u2014 PLAY'S does not let you read your whole deck. A search shows up to three distinct cards matching the condition, drawn at random from those that qualify, and you pick one. Most paper search effects were converted to this.",
    ...
    "J Change": "J\u30c1\u30a7\u30f3\u30b8 \u2014 when this creature attacks, swap it with a Jokers creature costing at or below the stated number from your mana zone. Unlike Revolution Change the ability sits on the creature leaving, and it pulls from mana rather than hand.",
