...
(function () {
  var TERMS = {
    ...
    "Revolution 0 Trigger": "革命0トリガー kakumei zero trigger — Playable from your hand for free, but only when a creature attacks you and you have no shields left. Several can be declared at once and resolve in the order you choose.",
    ...
    "super-dimension": "超次元 chōjigen — A zone outside the deck holding Psychic creatures. Unlike GR, cards here are summoned deterministically \u2014 an effect names what it brings out.",
